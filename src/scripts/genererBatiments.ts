import { Batiment, TypeBatiment, Service } from '../types';
...
const batiments: Batiment[] = [
  ...
  },
  {
    ...
    type: 'bibliotheque' as TypeBatiment,
    position: { x: 30, y: 30 },
    occupants: [],
...
export function genererBatiments(): void {
